...
export const ScrambleWords = () => {
  ...
  const handleGuessSubmit = (e: React.FormEvent) => {
    ...
    if (guess === currentWord) {
      const newWords = words.slice(1); //si se adivino, quita la primera palabra 
      confetti({
        particleCount: 100,
        spread: 120,
        origin: { y: 0.6 },
      ...
      setPoints(points + 1); //suma un punto por adivinar
      setGuess('') // limpia la caja de texto y manda un string vacio 
      setWords(newWords); 
